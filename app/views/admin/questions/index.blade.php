					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<tbody>
							@foreach($questions as $question)
								<tr>
									<td>
										<input type="checkbox" class="checkboxes" value="{{ $question->id }}"/>
									</td>
									<td>
										{{ $question->modules->module_name }}
									</td>
									<td>
										{{ $question->questionTypes->question_type }}
									</td>
									...
									<td>
										...
										@foreach($question->choices as $choice)
											@if($choice->order == $question->answer)
												{{ $choice->choice }}
											@endif
										@endforeach
									...
									<td>
										<a class="edit" href="{{ URL::route('admin.questions.edit', $question->id) }}">
											Edit
										</a>
									
										|
										<a class="delete" href="{{ URL::route('admin.questions.destroy', $question->id) }}">
											Delete
										</a>
