						...
						<tbody>
							@foreach($modules as $module)
								<tr>
									...
									<td>
										<a class="add-questions" href="{{ URL::route('admin.questions.create', $module->id) }}">
											 Add
										</a>
										|
										<a class="view-questions" href="{{ URL::route('admin.questions', $module->id) }}">
											 View
										</a>
										<br/>
									...
									<td>
										<a class="view" href="{{ URL::route('admin.modules.show', $module->id) }}">
											 View
										</a>
										|
